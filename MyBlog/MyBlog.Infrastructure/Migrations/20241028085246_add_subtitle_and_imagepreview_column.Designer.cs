...
namespace MyBlog.Infrastructure.Migrations
{
    ...
    [Migration("20241028085246_add_subtitle_and_imagepreview_column")]
    partial class add_subtitle_and_imagepreview_column
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBlog.Domain.Models.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Company = "My Company",
                            Created = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(377),
                            ...
                            Updated = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(386)
                        });
                });
            ...
            modelBuilder.Entity("MyBlog.Domain.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(411),
                            IsActive = true,
                            ProfileId = -1,
                            Subtitle = "This is my first post",
                            Title = "My First Post",
                            Updated = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(412)
                        },
                        new
                        {
                            Id = -2,
                            Content = "This is my second seed post",
                            Created = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(415),
                            IsActive = true,
                            ProfileId = -1,
                            Subtitle = "This is my second post",
                            Title = "My Second Post",
                            Updated = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(415)
                        });
                });
            ...
            modelBuilder.Entity("MyBlog.Domain.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(401),
                            ...
                            Updated = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(402)
                        });
                });
            ...
            modelBuilder.Entity("MyBlog.Domain.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(393),
                            ...
                            Updated = new DateTime(2024, 10, 28, 15, 52, 46, 214, DateTimeKind.Local).AddTicks(393)
                        });
                });
